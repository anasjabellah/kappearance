      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">K-appearance</span>
            </a>
            ...
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Managment</span></li>
                ...
                <li class="menu-item">
                    ...
                    @foreach ($categories as $Category)
                        <li class="menu-item">
                          <a href="{{ url('product' ,  $Category->id  ) }}" class="menu-link">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Table /</span> Category</h4>

            <!-- Button trigger modal -->
             <a href="{{ url('Category/create') }}" class="btn btn-primary text-bg-dark mb-3"> Add Category</a>
                ...
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    @foreach ($categories as $Category)
                      <tr>
                        <td>{{ $Category->id }}</td>  
                        <td><img src="{{ url('images', $Category->image ) }}" style="width: 100px; "></td>
                        <td>{{ $Category->name }}</td>  
                      </td>  
