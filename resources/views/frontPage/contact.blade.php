                                ...
                                <li class="dropdown position-static"><a href="#">Categories <i
                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            ...
                                            <ul class="d-block">
                                                <li class="title"><a href="shop-4-column.html">Men</a></li>
                                                <li class="title"><a href="shop-4-column.html">Women</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-4-column.html"><img class="img-responsive w-100" src="assets/images/banner/3.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-4-column.html"><img class="img-responsive w-100" src="assets/images/banner/4.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
